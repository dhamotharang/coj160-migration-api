...
import { ReceiptChequeService } from './receipt-cheque.service';

@ApiTags("Finance: Receipt cheque")
@Controller('finance/receiptCheque')
export class ReceiptChequeController {
  constructor(
    private mainService: ReceiptChequeService,
  ...
  async createData(@Res() res, @Req() req, @Body() body: OracleFinReceiptChequeDTO) {
