...
import { ReceiptBalanceHistoryService } from './receipt-balance-history.service';

@ApiTags("Finance: Receipt balance history")
@Controller('finance/receiptBalanceHistory')
export class ReceiptBalanceHistoryController {
  constructor(
    private mainService: ReceiptBalanceHistoryService,
  ...
  async createData(@Res() res, @Req() req, @Body() body: OracleFinReceiptBalanceHistorieDTO) {
