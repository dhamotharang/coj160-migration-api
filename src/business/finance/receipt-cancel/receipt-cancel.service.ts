...
@Injectable()
export class ReceiptCancelService extends HelperService {
  constructor(
    @InjectRepository(OracleFinReceiptCancels)
    private readonly oracleFinReceiptCreditRepositories: Repository<OracleFinReceiptCancels>,
  ) {
    super();
  }
  ...
  // POST Method
  async createData(payloadId: number, data: OracleFinReceiptCancelDTO) {
    try {
