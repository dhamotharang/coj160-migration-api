...
import { AppointResultService } from './appoint-result.service';

@ApiTags("Proceed: Appoint result")
@Controller('proceedAppointResult')
export class AppointResultController {
  constructor(
    private mainService: AppointResultService,
