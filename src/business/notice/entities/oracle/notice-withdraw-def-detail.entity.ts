...
export class OracleNoticeWithdrawDefDetails {
  ...
  toResponseObject() {
    ...
    const responseObject = { detailId, orderNo, defendantId, notes, prisonId, witdrawId, withdrawType, createdBy, updatedBy, removedBy, createdDate, updatedDate, removedDate };
