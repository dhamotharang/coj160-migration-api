...
@Entity({ name: 'PC_LABOR_COMPLAINANT_ACCUSER' })
export class OraclePcLaborComplainantAccusers {
    @PrimaryGeneratedColumn({ name: 'ACCUSER_ID', comment: 'รหัสข้อมูลระบบบันทึกคดีแรงงาน (รง.2) ส่วนผู้ร้อง (AUTO INCREMENT)' }) accuserId: number;
