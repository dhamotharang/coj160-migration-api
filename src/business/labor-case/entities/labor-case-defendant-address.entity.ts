...
@Entity({ name: 'PC_LABOR_CASE_DEFENDANT_ADDRESS' })
export class OraclePcLaborCaseDefendantAddress {
    @PrimaryGeneratedColumn({ name: 'DEFENDANT_ADDRESS_ID', comment: 'รหัสระบบบันทึกคดีแรงงาน รง. 4 ส่วนที่อยู่จำเลย (AUTO INCREMENT)' }) defendantAddressId: number;
    ...
    @Column({ name: 'LABOR_CASE_DEFENDANT_ID', nullable: false, comment: 'รหัสระบบบันทึกคดีแรงงาน รง.4 ส่วนจำเลย เชื่อมโยง PC_LABOR_CASE_DEFENDANT' }) laborCaseDefendantId: number;
    ...
    toResponseObject() {
        const { defendantAddressId, createdBy, createdDate, updatedBy, updatedDate, removedBy, removedDate, orderNo, addressNo, addressTypeId, countryId, districtId, laborCaseDefendantId, moo, phoneNumber, post, provinceId, road, soi, subDistrictId } = this;
        const responseObject = { defendantAddressId, createdBy, createdDate, updatedBy, updatedDate, removedBy, removedDate, orderNo, addressNo, addressTypeId, countryId, districtId, laborCaseDefendantId, moo, phoneNumber, post, provinceId, road, soi, subDistrictId };
