...
@Entity({ name: 'PC_LABOR_INDICTMENT_ACCUSER' })
export class OraclePcLaborIndictmentAccuser {
    @PrimaryGeneratedColumn({ name: 'ACCUSER_ID', comment: 'รหัสข้อมูลคำฟ้องตามแบบ (รง.1) ส่วนโจทก์ (AUTO INCREMENT)' }) accuserId: number;
    ...
    toResponseObject() {
        const { accuserId, createdBy, createdDate, orderNo, removedBy, removedDate, updatedBy, updatedDate, accuserAge, accuserBirthdate, accuserEmail, accuserLastname, accuserLitTypeId, accuserName, accuserNameTitle, accuserNationalId, accuserNationalIdCard, accuserOccupationId, accuserOrderNo, accuserPersonalTypeId, accuserRaceId, accuserSexId, accuserTel, indictmentId } = this;
        const responseObject = { accuserId, createdBy, createdDate, orderNo, removedBy, removedDate, updatedBy, updatedDate, accuserAge, accuserBirthdate, accuserEmail, accuserLastname, accuserLitTypeId, accuserName, accuserNameTitle, accuserNationalId, accuserNationalIdCard, accuserOccupationId, accuserOrderNo, accuserPersonalTypeId, accuserRaceId, accuserSexId, accuserTel, indictmentId };
