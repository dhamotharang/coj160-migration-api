...
@Entity({ name: 'PC_LABOR_INDICTMENT_ACCUSER_ADDRESS' })
export class OraclePcLaborIndictmentAccuserAddress {
    @PrimaryGeneratedColumn({ name: 'ACCUSER_ADDRESS_ID', comment: 'รหัสข้อมูลคำฟ้องตามแบบ (รง.1) ส่วนที่อยู่โจทก์ (AUTO INCREMENT)' }) accuserAddressId: number;
    ...
    @Column({ name: 'INDICTMENT_ACCUSER_ID', nullable: false, comment: 'รหัสข้อมูลคำฟ้องตามแบบ ส่วนโจทก์ เชื่อมโยง PC_LABOR_INDICTMENT_ACCUSER' }) indictmentAccuserId: number;
    ...
    toResponseObject() {
        const { accuserAddressId, createdBy, createdDate, updatedBy, updatedDate, removedBy, removedDate, orderNo, addressNo, addressTypeId, countryId, districtId, indictmentAccuserId, moo, phoneNumber, post, provinceId, road, soi, subDistrictId } = this;
        const responseObject = { accuserAddressId, createdBy, createdDate, updatedBy, updatedDate, removedBy, removedDate, orderNo, addressNo, addressTypeId, countryId, districtId, indictmentAccuserId, moo, phoneNumber, post, provinceId, road, soi, subDistrictId };
