...
@Entity({ name: 'PC_LABOR_INDICTMENT_DEFENDANT_ADDRESS' })
export class OraclePcLaborIndictmentDefendantAddress {
    @PrimaryGeneratedColumn({ name: 'DEFENDANT_ADDRESS_ID', comment: 'รหัสข้อมูลคำฟ้องตามแบบ (รง.1) ส่วนที่อยู่จำเลย (AUTO INCREMENT)' }) defendantAddressId: number;
    ...
    @Column({ name: 'INDICTMENT_DEFENDANT_ID', nullable: false, comment: 'รหัสข้อมูลคำฟ้องตามแบบ ส่วนจำเลย เชื่อมโยง PC_LABOR_INDICTMENT_DEFENDANT' }) indictmentDefendantId: number;
    ...
    toResponseObject() {
        const { defendantAddressId, createdBy, createdDate, updatedBy, updatedDate, removedBy, removedDate, orderNo, addressNo, addressTypeId, countryId, districtId, indictmentDefendantId, moo, phoneNumber, post, provinceId, road, soi, subDistrictId } = this;
        const responseObject = { defendantAddressId, createdBy, createdDate, updatedBy, updatedDate, removedBy, removedDate, orderNo, addressNo, addressTypeId, countryId, districtId, indictmentDefendantId, moo, phoneNumber, post, provinceId, road, soi, subDistrictId };
