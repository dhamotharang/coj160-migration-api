...
@Entity({ name: 'PC_LABOR_INDICTMENT_DEFENDANT' })
export class OraclePcLaborIndictmentDefendant {
    @PrimaryGeneratedColumn({ name: 'DEFENDANT_ID', comment: 'รหัสข้อมูลคำฟ้องตามแบบ (รง.1) ส่วนจำเลย (AUTO INCREMENT)' }) defendantId: number;
    @Column({ name: 'INDICTMENT_ID', nullable: false, comment: 'รหัสข้อมูลคำฟ้องตามแบบ เชื่อมโยง PC_LABOR_INDICTMENT' }) indictmentId: number;
    ...
    toResponseObject() {
        const { defendantId, indictmentId, createdBy, createdDate, updatedBy, updatedDate, removedBy, removedDate, orderNo, defendantAge, defendantBirthdate, defendantEmail, defendantLastname, defendantLitTypeId, defendantName, defendantNameTitle, defendantNationalId, defendantNationalIdCard, defendantOccupationId, defendantOrderNo, defendantPersonalTypeId, defendantRaceId, defendantSexId, defendantTel } = this;
        const responseObject = { defendantId, indictmentId, createdBy, createdDate, updatedBy, updatedDate, removedBy, removedDate, orderNo, defendantAge, defendantBirthdate, defendantEmail, defendantLastname, defendantLitTypeId, defendantName, defendantNameTitle, defendantNationalId, defendantNationalIdCard, defendantOccupationId, defendantOrderNo, defendantPersonalTypeId, defendantRaceId, defendantSexId, defendantTel };
