...
import { LookupAppointListService } from './lookup-appoint-list.service';

@ApiTags("Lookup: Appoint list")
@Controller('lookup/appointList')
export class LookupAppointListController {
  constructor(
    private readonly mainService: LookupAppointListService,
