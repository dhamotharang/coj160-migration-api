...
import { LookupAppointTableService } from './lookup-appoint-table.service';

@ApiTags("Lookup: Appoint Table")
@Controller('lookup/appointTable')
export class LookupAppointTableController {
  constructor(
    private mainService: LookupAppointTableService,
