...
import { LookupNoticeSendMethodService } from './lookup-notice-send-method.service';

@ApiTags("Lookup: Send method")
@Controller('lookup/sendMethod')
export class LookupNoticeSendMethodController {
  constructor(
    private mainService: LookupNoticeSendMethodService,
  ...
  async createData(@Res() res, @Req() req, @Body() body: OracleLookupSendMethodDTO) {
